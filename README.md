...
| `LTR-0017` | [Detect Super Admin Grants and 2SV Tampering in Google Workspace Audit Logs](https://logtriage.app/rules/google-workspace-admin-takeover/) | Google Workspace | T1098, T1556.006, T1078.004 | critical |
...
| `LTR-0015` | [Detect SQL Injection and Follow-on Data Exfiltration in nginx Access Logs](https://logtriage.app/rules/nginx-sqli-data-exfiltration/) | nginx / Apache access logs | T1190, T1595.002 | high |
...
| `LTR-0016` | [Detect Anonymous S3 Object Reads and Malicious Uploads in Server Access Logs](https://logtriage.app/rules/s3-anonymous-access-exfiltration/) | AWS S3 Server Access Logs | T1530, T1608.001 | high |
...
| `LTR-0018` | [Detect Web Attack Recon and SQL Injection in Zeek HTTP Logs](https://logtriage.app/rules/zeek-http-web-attack-recon/) | Zeek | T1595.002, T1190, T1083 | high |
...
Maintained by [LogTriage](https://logtriage.app). Generated 2026-09-18.
